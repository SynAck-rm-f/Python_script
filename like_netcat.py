...
def client_handler(client_socket):
    ...
    if len(upload_destination):
        ...
        # read bytes and write to our destination
        file_buffer = ""
...
def usage():
    ...
    print()
    print("Usage: like_netcat.py -t target_host -p port")
    print(
    ...
    print()
    print("Examples: ")
    print("like_netcat.py -t 192.168.0.1 -p 5555 -l -c")
    print("like_netcat.py -t 192.168.0.1 -p 5555 -l -u=c:\\target.exe")
    print("like_netcat.py -t 192.168.0.1 -p 5555 -l -e=\"cat /etc/passwd\"")
    print("echo 'ABCDEfFGeeHI' | ./like_netcat.py -t 192.168.11.12 -p 135")
    sys.exit(0)
